...
You can use [**this download link**](http://monticore.de/download/MCSD4Development.jar) 
...
Usually, the tools of MontiCore languages automatically generate the contents of these files and
