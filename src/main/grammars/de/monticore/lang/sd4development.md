...
the executable jar `SD4DevelopmentTool`, which can be found
in the directory `target/libs`. The usage of the `SD4DevelopmentTool` tool and detailed instructions
